...
calcularValorTotal = function () {
    ...
    */
    ...
    let mensaje="Valor a pagar por "+cantidad+" "+nombreProducto+" con "+porcentajeDescuento+" % es de USD: "+valorTotal
...
limpiar = function () {
    ...
    let cadenaVacia=""    
    mostrarTextoEnCaja("lblSubtotal",cadenaVacia)
    mostrarTextoEnCaja("txtPorcentajeDescuento",cadenaVacia)
    mostrarTextoEnCaja("lblValorIVA",cadenaVacia)
    mostrarTextoEnCaja("lblTotal",cadenaVacia)    
